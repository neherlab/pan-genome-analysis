...
def gbk_translation(each_gb_path, gb_file, output_filename, geneID_to_geneSeqID_dict, geneID_to_description_dict):
    '''
    ...
    gene_nuc_seq_dict= each_gb_path + strainName +'_gene_nuc_dict.cpk';
            ...
            if feature.type=='CDS':
                if 'product' in feature.qualifiers and 'translation' in feature.qualifiers :
                    ...
                    geneID_to_description_dict[geneID]={'geneName': geneName,
                                                        ...
                                                        'geneName_annotation': '%s%s'%(geneName, annotation)}
...
def diamond_input(path, strain_lst):
    ...
    ''' 
    protein_folder=path+ 'protein_faa/'
    os.system('mkdir '+protein_folder);
    ...
    for istrain in strain_lst:
        ...
        gbk_translation(path,'%s%s'%(strain_name,'.gbk'), diamond_input_fname, geneID_to_geneSeqID_dict, geneID_to_description_dict )
